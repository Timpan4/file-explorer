...
- Pull requests to `main` should pass GitHub Actions on Windows and Ubuntu: `bun run typecheck`, `bun run test`, `bun run rust:test`, `bun run rust:check`, and `bun run build`.
